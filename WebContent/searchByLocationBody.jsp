...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <div class="grid_3">
  <div class="container">
   ...
   <div class="col-md-9 profile_left">
    ...
    <form >	
	  <div class="form_but1">
		<label class="col-sm-5 control-lable1" >Location : </label>
 ...
 <div class="paid_people">
  ...
  <%
   ...
   String name1=request.getParameter("address");
   String name2 = name1+"%";
   Users u = new Users();
   u.setEmailid((String)session.getAttribute("emailid"));
   String gender=UsersDao.getGender(u);
   String p2 = "profileimg/g.jpg";
   String sql="select * from users where lower (address) like lower(?) and gender!=?";
